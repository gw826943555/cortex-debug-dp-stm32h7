...
export function activate(context: ExtensionContext) {
    ...
    cortexDebug.activate().then((cdbg) => {
        ...
        cdbg.registerSVDFile(/^(STM|stm)32(h|H)745.*_(M|m)4.*/i, path.join(context.extensionPath, 'data', 'STM32H745_CM4.svd'));
        cdbg.registerSVDFile(/^(STM|stm)32(h|H)745.*_(M|m)7.*/i, path.join(context.extensionPath, 'data', 'STM32H745_CM7.svd'));
        cdbg.registerSVDFile(/^(STM|stm)32(h|H)747.*_(M|m)4.*/i, path.join(context.extensionPath, 'data', 'STM32H747_CM4.svd'));
        cdbg.registerSVDFile(/^(STM|stm)32(h|H)747.*_(M|m)7.*/i, path.join(context.extensionPath, 'data', 'STM32H747_CM7.svd'));
        ...
        cdbg.registerSVDFile(/^(STM|stm)32(h|H)755.*_(M|m)4.*/i, path.join(context.extensionPath, 'data', 'STM32H755_CM4.svd'));
        cdbg.registerSVDFile(/^(STM|stm)32(h|H)755.*_(M|m)7.*/i, path.join(context.extensionPath, 'data', 'STM32H755_CM7.svd'));
        cdbg.registerSVDFile(/^(STM|stm)32(h|H)757.*_(M|m)4.*/i, path.join(context.extensionPath, 'data', 'STM32H757_CM4.svd'));
        cdbg.registerSVDFile(/^(STM|stm)32(h|H)757.*_(M|m)7.*/i, path.join(context.extensionPath, 'data', 'STM32H757_CM7.svd'));
